          ...
          {({ values, handleChange }) => (
            <Form className="h-100   w-100">
              <Field
                ...
                className=" nav-input shadow-sm  h-100 w-100"></Field>
            </Form>
          )}
        </Formik>
      </div>
      <div className=" shadow-sm  nav-icon-container position-relative  .align-items-center gap-3 d-flex bg-white px-2   flex-row">
